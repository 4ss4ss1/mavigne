...
// v1.72 — Entretien : encart résumé compact · modal liste fiches · suppression/édition admin · toggle anomalie traitée · confirmation enregistrement
// v1.73 — Fix critique login : _syncLocalVars() appelé AVANT initLogin() dans applyFbData (MEMBRES local désynchronisé → profils invisibles) · retry initLogin robuste (5 tentatives × 1.5s + fallback localStorage)
