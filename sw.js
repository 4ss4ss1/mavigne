// MA VIGNE — Service Worker v1.51
// v1.50 — Debug chat : .get() test
// v1.51 — Fix CRITIQUE : suppression enablePersistence (bloquait Firestore sur iOS/multi-onglets)

const CACHE_NAME = 'mavigne-v1.51';
